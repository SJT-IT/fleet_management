...
class DealerOdoScreen extends StatefulWidget {
  const DealerOdoScreen({super.key});

  @override
  State<DealerOdoScreen> createState() => _DealerOdoScreenState();
}

class _DealerOdoScreenState extends State<DealerOdoScreen> {
  int _currentIndex = 0;
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            const Text(
              "Welcome Dealer Odometer Screen",
